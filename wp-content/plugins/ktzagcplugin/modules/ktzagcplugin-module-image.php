...
if ( !function_exists('ktzplg_get_bing_image') ) {
	 ...
	 * bing Image Scrape 
	 */
	function ktzplg_get_bing_image( $keyword, $num = 1, $related = false ) {
		 ...
		 */
		$fetch = ktzplg_fetch_agc( 'http://www.bing.com/images/search?q='.$keywords );
	...
	add_action('ktzplg_get_bing_image', 'ktzplg_get_bing_image', 10, 3);
}
...
if ( !function_exists('ktzplg_get_ask_image') ) {
	 ...
	 */
	function ktzplg_get_ask_image( $keyword, $num = 1, $related = false ) {
	...
	add_action('ktzplg_get_ask_image', 'ktzplg_get_ask_image', 10, 3);
}