<?php
/*
Plugin Name: Yugo Banyak Post
Description: Banyakin Posting Pake KW
*/
...
class NPBulkPostCreatorPlus {
	...
	static public function bulk_post_add_form() {
		...
		echo '<h2>Yugo Banyak Post</h2>'.PHP_EOL;
		echo '	
					...
					<div class="inner-sidebar">
						<div style="position: relative;" class="meta-box-sortabless ui-sortable" id="side-sortables">
							<div class="postbox" id="sm_pnres">
								<h3 class="hndle"><span>Tentang Plugin:</span></h3>
								<div class="inside">
									<ul>
									<li><a href="http://wahyu.xyz" class="sm_button sm_pluginHome">Plugin Homepage</a></li>
									</ul>
								</div>
							</div>
						</div>
	...
	private function display_form() {
		...
		echo '<table style="text-align: left; padding: 10px 30px;">
			<tr valign="top">
				<th scope="row">Masukkan Title disini, 1 Baris 1 Title</th>
				<td><textarea name="bulk_post_titles" cols="60" rows="20"></textarea></td>
			</tr>
			<tr valign="top">
				<th scope="row">Jenis Post</th>
				<td>
			...
			<tr valign="top">
				<th scope="row">Memulai Posting Dari:</th>
				<td>
	...
	static public function add_plugin_menu() {
		add_posts_page( 'Yugo Banyak Post', 'Yugo Banyak Post', 'edit_posts', 'bulk-post-creator-plus/np-bulk-post-creator-plus.php', array('NPBulkPostCreatorPlus','bulk_post_add_form'));
	}
}
