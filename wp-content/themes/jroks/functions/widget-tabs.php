...
?>
<?php if($popular_post_num != 1){echo '<div class="tabsSep"></div>';} ?>
<li>
<div class="left">
<?php if(has_post_thumbnail()): ?>
<?php $image = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), 'featured-small'); ?>
<a href='<?php the_permalink(); ?>'><img src="<?php echo $image[0]; ?>" alt="<?php the_title(); ?>"  width='82' height='60' class="wp-post-image" /></a>
<?php else: ?>
<a href='<?php the_permalink(); ?>'><img src="<?php bloginfo('template_directory'); ?>/images/smallthumb.png" alt="<?php the_title(); ?>"  width='82' height='60' class="wp-post-image" /></a>
<?php endif; ?>
<div class="clear"></div>
</div>
 	<div class="info">
    ...
    <span class="pcomments"><a rel="nofollow" href="<?php comments_link(); ?>"><?php comments_number('0 Comment','1 Comment','% Comments'); ?></a> |</span>
	<p><span class="theauthor"><?php the_author_posts_link(); ?></span></p>
	</div> <!--end .entry-meta--> 	
	</div> <!--end .info-->
	<div class="clear"></div>
</li>
...
?>
<?php if($recent_post_num != 1){echo '<div class="tabsSep"></div>';} ?>
<li>
<div class="left">
<?php if(has_post_thumbnail()): ?>
<?php $image = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), 'featured-small'); ?>
